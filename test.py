    ...
    with torch.no_grad():
        for image_file in image_list:
            if 'pred' not in image_file:
                ...
                # forward-pass
                pred_camera, pred_3d_joints, pred_vertices_sub2, pred_vertices_sub, pred_vertices, hidden_states, att = Graphormer_model(
...
def visualize_mesh_and_attention(renderer, images,
    ...
    rend_img = visualize_reconstruction_and_att_local(img, 224, vertices_full, vertices, vertices_2d, cam,
                                                      renderer, joints_2d, att, color='light_blue')
    rend_img = rend_img.transpose(2, 0, 1)
    return rend_img
